const Workout = require('../models/BodygardModel')
const mongoose = require('mongoose')


//GET all Workout
const getBodyguard = async (req,res) => {
...
//Create new Workout
const createBodyguard = async (req,res) => {
...
//delete a Workout
const deleteBodyguards = async (req,res) => {
    // const {id} = req.params
...
const deleteBodyguard = async (req,res) => {
    const {id} = req.params
